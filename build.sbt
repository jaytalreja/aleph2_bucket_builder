...
jsDependencies += "org.webjars.bower" % "angular-route" % "1.5.0-rc.0" / "angular-route.js" dependsOn "angular.js"

jsDependencies += "org.webjars.bower" % "angular" % "1.5.0-rc.0" / "angular.js" 
	//dependsOn "bootstrap.js"
	//(create fake dep to avoid multiple dependencies)

//jsDependencies += "org.webjars.bower" % "bootstrap" % "3.3.6" / "bootstrap.js"
jsDependencies += "org.webjars.bower" % "angular-bootstrap" % "0.14.3" / "ui-bootstrap.js" dependsOn "angular.js"
